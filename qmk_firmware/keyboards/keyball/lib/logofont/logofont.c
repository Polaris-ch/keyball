// Copyright 2024 MURAOKA Taro (aka KoRoN, @kaoriya): glyphs
//
//   - ASCII characters (0x20 ~ 0x7E)
//   - Special characters (0x80 ~ 0x93)
//
// Note: Keyball logo glyphs (originally 0x80~0xAF) have been removed
// to save flash size. Special characters were renumbered down by 0x30
// (e.g. old 0xB0 -> new 0x80) accordingly.
...
const unsigned char font[] PROGMEM = {
  ...
  // (Renumbered: originally 0xB0~0xC3, now 0x80~0x93, logo removed.)
